...
# you can untar https://github.sheincorp.cn/Homebrew/brew/tarball/master
# anywhere you like.
...
CHMOD=("/bin/chmod")
MKDIR=("/bin/mkdir" "-p")
HOMEBREW_BREW_DEFAULT_GIT_REMOTE="https://github.sheincorp.cn/Homebrew/brew"
HOMEBREW_CORE_DEFAULT_GIT_REMOTE="https://github.sheincorp.cn/Homebrew/homebrew-core"
...
REQUIRED_RUBY_VERSION=2.6    # https://github.sheincorp.cn/Homebrew/brew/pull/6556
...
Your Mac OS X version is too old. See:
  ${tty_underline}https://github.sheincorp.cn/mistydemeo/tigerbrew${tty_reset}
EOABORT
    )"
...
# https://github.sheincorp.cn/Homebrew/brew/blob/master/Library/Homebrew/keg.rb
directories=(
...
echo "$(
  cat <<EOS
  ${tty_underline}https://github.sheincorp.cn/Homebrew/brew#donations${tty_reset}
EOS
)
"
